...
.. code-block:: bash
   ...
   alias init_conda="source ~/mambaforge/etc/profile.d/conda.sh"
...
``python -m pip install -e .`` in the new worktree.  If you forget this
step, you will find that changes you make in the worktree don't affect
the ``mpas_dev`` conda environment you are using.
